...
# Example usage
file_root = "/home/v-qilinzhang/pissa_slsqft/google_robot_close_bottom_drawer/raw_adapter"
vision_sim = []
other_sim = []
...
# 保存图像文件
plt.savefig('cosine_similarity_plot_compare.png')

print("图像已保存为 'cosine_similarity_plot_compare.png'.")
