...
SperateTrain(){
    echo "SperateTrain"
    python CL-exp/sandbox_pissa_baseline.py --config_path=${config_path} --dataset_name=${dataset}
    echo "SperateTrain Done"
}

config_path="/home/v-qilinzhang/CL-exp/configs/sandbox/pissa_separate_baseline.yaml"
