...
class LoadConfigs:
    def __init__(self):
        ...
        self.adapter_path = "/mnt/data-qilin/mr_sqft/OLoRA_more_epochs/google_robot_close_bottom_drawer/raw_adapter/epoch49"
        self.ckpt_path = "/mnt/data-qilin/mr_sqft/OLoRA_more_epochs/google_robot_close_bottom_drawer/merged/epoch49"
